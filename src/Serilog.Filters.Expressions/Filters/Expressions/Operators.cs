...
namespace Serilog.Filters.Expressions
{
    ...
    {
        public static StringComparer OperatorComparer { get; } = StringComparer.OrdinalIgnoreCase;
        ...
        public static readonly HashSet<string> UserSyntaxRootOperators = new HashSet<string>(LogicalOperators, OperatorComparer)
        {
            OpHas,
            OpContains,
            OpStartsWith,
